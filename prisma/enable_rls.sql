-- Enable RLS on all sensitive tables and FORCE it (to apply to owner/app connection)
...
ALTER TABLE "ai_advice_cache" FORCE ROW LEVEL SECURITY;
...
ALTER TABLE "savings" FORCE ROW LEVEL SECURITY;
