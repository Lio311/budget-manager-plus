...
export default function LandingPage() {
    ...
    const sections = [
        ...
        },
        {
            ...
            description: 'פתרון מושלם לעצמאיים ועסקים קטנים. כל הכלים לניהול העסק במקום אחד, מסונכרן ומסודר.',
    ...
    return (
        <div ref={containerRef} className="h-screen w-full overflow-hidden relative selection:bg-emerald-500/30" dir="rtl">
            ...
            {/* Custom Footer */}
            {currentSection === sections.length - 1 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="fixed bottom-0 left-0 right-0 bg-black/80 backdrop-blur-md border-t border-white/10 py-6 z-40">
        ...
        <div className={`h-screen w-full relative overflow-hidden bg-gradient-to-br ${section.bgColor} flex items-center justify-center`}>
            ...
            <div className="container mx-auto px-6 h-full flex items-center relative z-10">
                ...
                {(section.type === 'personal' || section.type === 'business') && (
                    <div className="grid md:grid-cols-2 gap-12 items-center w-full h-full pt-20 pb-20">
                        <div className="text-right flex flex-col justify-center">
                            ...
                            <motion.h2 initial={{ opacity: 0, y: 30 }} animate={isActive ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.4 }} className="text-5xl md:text-6xl font-black text-white mb-4">{section.title}</motion.h2>
                ...
                {section.type === 'toolkit' && (
                    <div className="w-full h-full flex flex-col justify-center pt-20 pb-20">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 overflow-y-auto max-h-[65vh] p-4 custom-scrollbar">
...
function FeatureCard({ icon, title, desc, delay, isActive }: any) {
    return (
        <motion.div
            ...
            className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-center hover:bg-white/20 transition-all hover:-translate-y-1"
        >
