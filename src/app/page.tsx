            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent">
                <div className="container mx-auto px-6 h-20 flex items-center justify-between relative">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-full flex justify-center pointer-events-none">
                        <AuthModalTrigger redirectUrl={`/processing?next=${encodeURIComponent('/onboarding?trial=true')}`}>
...
function FAQContent() {
    const faqData = [
        ...
        { q: "האם יש תקופת ניסיון?", a: "כן, אנחנו מציעים 10 ימים ראשונים חינם ללא התחייבות, כדי שתוכלו להתנסות במערכת ולוודא שהיא מתאימה לכם." },
