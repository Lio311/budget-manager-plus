                        ...
                        <div className="p-8 overflow-y-auto max-h-[calc(90vh-200px)]">
                            <div className="space-y-6">
                                ...
                                <SecurityLayer
                                    ...
                                    description="הנתונים שלך הם שלך בלבד. המערכת בנויה בצורה כזו שכל משתמש מקבל גישה אך ורק לנתונים האישיים שלו. אף משתמש אחר לא יכול לראות או לגשת למידע שלך, בדיוק כמו כספת אישית ומאובטחת שרק לך יש את המפתח אליה."
                                />
