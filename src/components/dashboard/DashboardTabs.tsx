...
export function DashboardTabs({ mobileMenuOpen, setMobileMenuOpen }: DashboardTabsProps) {
    ...
    const personalTabs = [
        ...
        { value: 'income', label: 'הכנסות', icon: TrendingUp, activeClass: 'data-[state=active]:bg-green-600' },
    ...
    const businessTabs = [
        ...
        { value: 'income', label: 'מכירות', icon: TrendingUp, activeClass: 'data-[state=active]:bg-green-600' },
