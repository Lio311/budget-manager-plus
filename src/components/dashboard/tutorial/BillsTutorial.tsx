...
export function BillsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'bills-summary',
                title: 'סיכום חשבונות',
                text: 'סקירה מהירה של סך התשלומים החודשיים, כמה שולם וכמה נותר לשלם החודש.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'bills-form',
                title: 'הוספת חשבון',
                text: 'כאן ניתן להוסיף חשבון חדש (כגון חשמל, ארנונה, אינטרנט) ולהגדיר את יום התשלום.',
                placement: 'right',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'bills-list-header',
                title: 'סינון ומיון',
                text: 'כלים למיון וסינון רשימת החשבונות כדי למצוא בקלות את מה שאתה מחפש.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                id: 'bills-list-container',
                title: 'רשימת החשבונות',
                text: 'כל החשבונות שלך מרוכזים כאן. סמן כ"שולם", ערוך פרטים או מחק חשבונות שאינם רלוונטיים.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
