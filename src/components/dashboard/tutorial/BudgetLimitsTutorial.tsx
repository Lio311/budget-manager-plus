...
export function BudgetLimitsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'limits-summary',
                title: 'תקציב חודשי',
                text: 'סיכום התקציב הכולל שהגדרת והסכום שנוצל בפועל עד כה.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'limits-auto-calc',
                title: 'המלצה חכמה',
                text: 'תן למערכת לנתח את ההוצאות שלך ולהציע תקציב מותאם אישית באופן אוטומטי.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'limits-add',
                title: 'הוספת תקציב לקטגוריה',
                text: 'בחר קטגוריה (למשל מזון, דלק) והגדר לה תקרה חודשית.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                id: 'limits-list',
                title: 'ניהול תקציבים',
                text: 'רשימת התקציבים הפעילים. השתמש במחוון (Slider) כדי לשנות את התקציב בקלות.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
