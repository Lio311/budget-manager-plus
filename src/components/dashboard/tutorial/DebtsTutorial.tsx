...
export function DebtsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'debts-summary',
                title: 'מצב ההלוואות',
                text: 'תמונת מצב של כל ההלוואות והחובות, כולל יתרה כוללת ותשלום חודשי צפוי.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'debts-form',
                title: 'הלוואה חדשה',
                text: 'הוסף הלוואה חדשה למעקב. ניתן להגדיר אם אתה חייב כסף או שחייבים לך.',
                placement: 'right',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'debts-list-header',
                title: 'ניהול ומיון',
                text: 'אפשרויות למיון ההלוואות לפי סכום, תאריך סיום או שם.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                id: 'debts-list-container',
                title: 'רשימת ההלוואות',
                text: 'רשימה מפורטת של כל ההלוואות. עקוב אחר היתרה והתשלומים ועדכן סטטוס.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
