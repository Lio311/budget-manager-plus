...
export function ProfitLossTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'pl-view-toggle',
                title: 'בחירת תצוגה',
                text: 'בחר בין תצוגה שנתית, דו-חודשית או חודשית. כל תצוגה מציגה את הדוחות בפירוט שונה.',
                placement: 'bottom',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'pl-year-selector',
                title: 'בחירת שנה',
                text: 'בחר את השנה עבורה ברצונך לצפות בדוחות. ניתן לצפות בדוחות משנת ההרשמה ועד השנה הבאה.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                id: 'pl-periods-grid',
                title: 'כרטיסי תקופות',
                text: 'כל כרטיס מייצג תקופה (חודש/דו-חודש/שנה). סטטוס: סגור (אפור), פתוח (ירוק מהבהב), עתידי (כחול). לחץ על "צפה בדוח" כדי לראות פירוט מלא.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 340
            }
        ...
        cards.forEach(config => {
            ...
            if (el) {
                ...
                if (placement === 'bottom') {
                    ...
                    if (align === 'start') style.left = absLeft - 10
                    if (align === 'end') style.left = absRight - width + 10
                    ...
                    if (align === 'start') arrowStyle.left = '20px', arrowStyle.transform = 'translateX(0) rotate(45deg)'
                    if (align === 'end') arrowStyle.left = `${width - 30}px`, arrowStyle.transform = 'translateX(0) rotate(45deg)'
                    ...
                    if (align === 'start') arrowStyle.left = '20px', arrowStyle.transform = 'translateX(0) rotate(225deg)'
                    if (align === 'end') arrowStyle.left = `${width - 30}px`, arrowStyle.transform = 'translateX(0) rotate(225deg)'
                }
