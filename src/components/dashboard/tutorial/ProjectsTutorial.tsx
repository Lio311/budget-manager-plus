...
export function ProjectsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'projects-add-btn',
                title: 'פרויקט חדש',
                text: 'צור פרויקט חדש כדי לנהל תקציב נפרד למטרה ספציפית (למשל: חופשה, שיפוץ).',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                id: 'projects-list',
                title: 'הפרויקטים שלי',
                text: 'כל הפרויקטים שלך במקום אחד. לחץ על פרויקט לצפייה בפרטים מלאים, הכנסות והוצאות.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
