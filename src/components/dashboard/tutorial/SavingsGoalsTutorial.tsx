...
export function SavingsGoalsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'goals-summary',
                title: 'סטטוס יעדים',
                text: 'מדדי ביצוע מרכזיים: כמה יעדים יש, כמה נחסך בסך הכל ומה אחוז ההתקדמות הכללי.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'goals-list',
                title: 'יעדים לפי קטגוריה',
                text: 'פירוט היעדים שלך. לכל קטגוריה ניתן להגדיר יעד כספי ולראות כמה נשאר להגיע אליו.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
