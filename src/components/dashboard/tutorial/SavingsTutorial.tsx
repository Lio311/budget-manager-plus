...
export function SavingsTutorial({ isOpen, onClose }: TutorialProps) {
        ...
        const cards: CardConfig[] = [
            {
                id: 'savings-summary',
                title: 'סיכום חסכונות',
                text: 'סה"כ הפקדות חודשיות ומספר תוכניות החיסכון הפעילות כרגע.',
                placement: 'bottom',
                align: 'center',
                maxWidth: 300
            },
            {
                id: 'savings-form',
                title: 'חיסכון חדש',
                text: 'פתח תוכנית חיסכון חדשה או תעד הפקדה חד פעמית לחיסכון קיים.',
                placement: 'right',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'savings-list-header',
                title: 'סינון תוכניות',
                text: 'מיין וסנן את תוכניות החיסכון שלך לפי סוג, סכום או תאריך.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                ...
                title: 'החסכונות שלי',
                text: 'רשימת כל החסכונות שלך. כאן ניתן לעקוב אחר ההתקדמות ולבצע שינויים.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
