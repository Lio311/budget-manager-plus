...
export function SuppliersTutorial({ isOpen, onClose }: TutorialProps) {
    ...
    const calculatePositions = () => {
        ...
        const cards: CardConfig[] = [
            {
                ...
                title: 'ניהול חבילות והסכמים',
                text: 'כאן ניתן לנהל את סוגי החבילות, סטאטוסים וצבעי תיוג לספקים. הגדרות אלו עוזרות בארגון ומיון הספקים באופן ויזואלי מהיר.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                ...
                title: 'הוספת ספק חדש',
                text: 'כפתור זה פותח טופס להוספת ספק חדש. ניתן להזין את פרטי הספק, איש קשר, פרטי התקשרות, וכן לשייך אותו לחבילה או הסכם שירות.',
                placement: 'bottom',
                align: 'end',
                maxWidth: 300
            },
            {
                ...
                title: 'חיפוש ספקים',
                text: 'שורת חיפוש מהירה לאיתור ספק לפי שם, טלפון, אימייל או ח.פ. הסינון מתבצע בזמן אמת.',
                placement: 'bottom',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'suppliers-sort-controls',
                title: 'אפשרויות תצוגה ומיון',
                text: 'כלי למיון רשימת הספקים לפי שם, תאריך הצטרפות, סך הוצאות או סטטוס. כמו כן, ניתן להחליף בין תצוגת כרטיסים (Grid) לתצוגת רשימה (List).',
                placement: 'bottom',
                align: 'start',
                maxWidth: 300
            },
            {
                id: 'suppliers-list-container',
                title: 'רשימת הספקים',
                text: 'תצוגת כל הספקים במערכת. בכל כרטיס ספק ניתן לראות את פרטיו החשובים, סטטוס התשלום, וקיצורי דרך לעריכה, מחיקה או צפייה בהיסטוריית תשלומים.',
                placement: 'top',
                align: 'center',
                maxWidth: 320
            }
        ...
        cards.forEach(config => {
            ...
            // Mobile ID overrides
            if (isMobileView) {
                if (config.id === 'suppliers-add-btn') targetId = 'suppliers-add-fab'
            }
