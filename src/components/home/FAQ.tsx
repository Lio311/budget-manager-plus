...
const faqData = [
    ...
    {
        question: "האם יש גרסת חינם?",
        answer: "בוודאי. ניתן להירשם ולהשתמש במערכת לניהול תקציב אישי בחינם וללא הגבלת זמן. הגרסה העסקית והמתקדמת זמינה לתקופת ניסיון של 14 יום ללא התחייבות."
    },
    {
        question: "איזה דוחות ניתן להפיק?",
        answer: "המערכת מציעה מגוון רחב של דוחות: דוח הכנסות והוצאות חודשי/שנתי, פילוח לפי קטגוריות, תזרים מזומנים עתידי, דוחות מע\"מ ומקדמות לעסקים, ודוח רווח והפסד."
    },
    {
