            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                    ...
                    <div>
                        ...
                        <span className="text-2xl font-bold text-emerald-600">{formatNumberWithCommas(revenue.toFixed(2))} ₪</span>
                ...
                >
                    ...
                    <div>
                        ...
                        <span className="text-2xl font-bold text-rose-600">{formatNumberWithCommas(expenses.toFixed(2))} ₪</span>
                ...
                >
                    ...
                    <div>
                        ...
                        <span className="text-2xl font-bold text-blue-600">{formatNumberWithCommas(profit.toFixed(2))} ₪</span>
