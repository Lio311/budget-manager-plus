    ...
    return (
        <div className="prose max-w-none text-right leading-relaxed text-gray-800 font-open-sans" dir="rtl">
            ...
            <ul className="list-disc pr-6 mb-6">
                ...
                <li><strong>שלב ב' – החל מהמשתמש ה-101 ואילך:</strong> מרגע הגעת המיזם ל-100 משתמשים משלמים, כל הוצאה עתידית תתחלק שווה בשווה בין שלושת השותפים (40% ליאור, 40% רון, 20% לאון), או תשולם מתוך רווחי המיזם (במידה וישנם). יש לחדד כי רווחי המיזם עד המשתמש ה-100 לא יחולו על כיסוי ההוצאות הראשוני, אלא, רק מהמשתמש ה-101.</li>
            </ul>
