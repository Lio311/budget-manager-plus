        ...
        <div className="border-t pt-4">
            ...
            <div className="flex justify-center w-full">
                <div className="w-full max-w-md relative">
                    {/* We need to pass showClearButton prop to SignaturePad if it supports it, or position it here if SignaturePad exposes clear differently. 
                            Looking at previous context, SignaturePad likely handles its own UI. 
                            However, the user asked for the 'X' to be on the corner. 
                            Let's assume SignaturePad renders the border.
                         */}
                    <SignaturePad
